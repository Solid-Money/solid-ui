        ...
        build: {
          experimental: {
            ios: {
              ...
              appExtensions: [
                { targetName: 'IssuerNonUIExtension', bundleIdentifier: 'app.solid.xyz.IssuerNonUIExtension' },
                { targetName: 'IssuerUIExtension', bundleIdentifier: 'app.solid.xyz.IssuerUIExtension' },
              ],
            },
          },
        },
