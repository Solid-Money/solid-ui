...
const faqs: Faq[] = [
  ...
  },
  {
    ...
    answer:
      'Yield comes from **BoringVaults** — a set of curated DeFi strategies across chains. Capital is deployed into **secure, audited protocols** with strong performance histories (e.g., lending markets, staking). Strategies are selected based on **risk, uptime**, and **on-chain performance**, ensuring your SoUSD earns reliable, **risk-adjusted yield** — without you lifting a finger.',
  },
];
