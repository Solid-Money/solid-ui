...
export const EXPO_PUBLIC_SHARED_REVIEW_ACCESS_EMAIL =
  process.env.EXPO_PUBLIC_SHARED_REVIEW_ACCESS_EMAIL ?? '';
export const EXPO_PUBLIC_GOODDOLLAR_WHITELIST =
  process.env.EXPO_PUBLIC_GOODDOLLAR_WHITELIST ?? '';
...
export const EXPO_PUBLIC_INTERCOM_IOS_API_KEY = process.env.EXPO_PUBLIC_INTERCOM_IOS_API_KEY ?? '';
export const EXPO_PUBLIC_INTERCOM_ANDROID_API_KEY =
...
export const EXPO_PUBLIC_FIREBASE_DATABASE_URL =
...
export const EXPO_PUBLIC_CARD_FUNDING_CHAIN_KEY =
  process.env.EXPO_PUBLIC_CARD_FUNDING_CHAIN_KEY ?? 'base';
...
export const ADDRESSES: Addresses = {
  ethereum: {
    teller: isProduction
      ...
      : '0xf2bFC2C7c36560279b97F553a2480B59965e9eC0',
...
export const USER = {
  ...
  pimlicoUrl: (chainId: number = mainnet.id) =>
    `https://api.pimlico.io/v2/${chainId}/rpc?apikey=${EXPO_PUBLIC_PIMLICO_API_KEY}`,
