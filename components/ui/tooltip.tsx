        ...
        >
          <TextClassContext.Provider value="text-sm native:text-base text-primary-foreground">
            <TooltipPrimitive.Content
              ...
              className={cn(
                'z-50 overflow-hidden rounded-md bg-foreground px-3 py-1.5 shadow-md shadow-foreground/5 web:animate-in web:fade-in-0 web:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2',
                className,
              )}
              {...props}
            />
