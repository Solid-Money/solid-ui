...
const UP_PATH = 'M 0 20 C 8 18 12 17 18 14 C 24 11 28 14 34 11 C 40 8 50 7 60 3';
const DOWN_PATH = 'M 0 4 C 8 6 12 8 18 10 C 24 12 28 9 34 13 C 40 16 50 17 60 21';
