    ...
    <PageLayout desktopOnly mobileTitle={null}>
      <View className="mx-auto w-full max-w-lg flex-1 gap-6 px-4 py-6">
        ...
        <View className="flex-row items-center justify-between">
          ...
          <Pressable
            onPress={() => (router.canGoBack() ? router.back() : router.replace(path.REWARDS))}
        ...
        <View className="gap-4 rounded-twice bg-card p-5">
          <InfoRow icon="images/wallet-yellow-background.png">Have a Solid card issued.</InfoRow>
          <InfoRow icon="images/share-yellow-background.png">Share your referral link.</InfoRow>
          <InfoRow icon="images/card-yellow-background.png">
